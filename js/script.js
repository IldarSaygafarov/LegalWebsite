...
var consultationSelect = document.querySelector('.consultation-form__select');
var consultationDropdown = document.querySelector('.consultation-form__dropdown');
consultationSelect.addEventListener('click', function (e) {
  consultationSelect.classList.toggle('open');
  consultationDropdown.classList.toggle('open');
});
var consultBtns = document.querySelectorAll('#consult');
...
var mainSlider = new Swiper('.slider-page__container', {
  slidesPerView: 1,
  autoHeight: true,
  loop: false,
  navigation: {
